...
<head>
    ...
    <title>Accueil Comptable - GSB</title>
    <style>
        body {
            margin: 0;
...
<nav>
    <ul>
        <li><a href="fichesavalider.php">Voir les fiches à valider</a></li>
        <li><a href="statistiques.php" class="btn">Voir les statistiques</a></li>
